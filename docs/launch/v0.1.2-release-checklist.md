...
Use this checklist to publish `v0.1.2 Customer Proof`. This release is prepared
in the repo, but no tag or GitHub Release should exist until the publish stage.
...
- GitHub Release URL: `TBD when publishing`
