...
The eighth public release is now live: `v0.1.7 Catalog Evidence`, which
packages static public evidence examples for every Suite Catalog starter pack.
...
Current release: https://github.com/Martin123132/sentinel-manifold-public/releases/tag/v0.1.7
